...
1. **ASK** – explore and understand the codebase
2. **PLAN** – define approach (prefer Markdown over chat)
3. **AGENT** – implement the plan
...
- Rules files should be used for each codebase
...
- The engineer is still accountable for the outputs of AI models.
